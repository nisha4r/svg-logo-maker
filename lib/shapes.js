...
class Square extends Shape {
    ...
    render() {
       return `<?xml version="1.0" standalone="no"?>
       <svg width="300" height="200" version="1.1" xmlns="http://www.w3.org/2000/svg"><rect x="100" y="125" width="150" height="150" stroke="${this.shapeBgColor}" fill="${this.shapeBgColor}" stroke-width="1" />
